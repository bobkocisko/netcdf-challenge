...
When querying /get-image?time_index=7&z_index=0, the api doesn't respond due to the matplot++ library delaying indefinitely.  This must be due to the fact that all data values are 0.0, but I ran out of time to figure out and resolve the issue here.
